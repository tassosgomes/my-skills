# Referência completa — Testes Java

> Leia sob demanda para unitários, integração, E2E, Testcontainers e Dev Containers.

Documento normativo para estrategias de teste.
Use este guia para projetar ou validar testes; o gate deve ser proporcional ao risco da mudança.
