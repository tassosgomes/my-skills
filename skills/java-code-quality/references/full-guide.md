# Referência completa — Qualidade Java

> Leia sob demanda para as regras detalhadas de naming, métodos, null safety, DI, exceções, records e logging.

Documento normativo para geracao de codigo por LLMs.
Define regras obrigatorias e diretrizes de qualidade de codigo Java.
Use este guia somente depois que o core tiver roteado o diff para qualidade de código.
