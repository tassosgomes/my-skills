...
- **full:** execute a suíte completa do projeto — o mesmo comando que o CI roda no merge.
...
Comando de diagnóstico — pular testes, `--dry-run`, execução parcial — nunca vira aprovação.
